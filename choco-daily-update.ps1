...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/dxf/chocolatey/master/program_list.config" -OutFile "C:\tempdl\program_list.config"
choco install program_list.config -y
$Trigger= New-ScheduledTaskTrigger -At 09:00pm -Daily
